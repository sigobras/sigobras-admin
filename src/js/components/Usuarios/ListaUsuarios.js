...
class ListaUsuarios extends Component {
  ...
  componentWillMount() {
    axios
      ...
      .catch(error => {
        console.log(
          "algo salió mal al tratar de listar los usuarios error es: ",
          error
        );
      });
  }
  ...
  enviarDatosUsuarios(event) {
    ...
    axios
      .post(`${UrlServer}/nuevoUsuario`, formData, config)
  ...
  ActualizarUsuario(event) {
    ...
    console.log(usuario);
    axios
      .put(`${UrlServer}/putActualizarUsuario`, usuario)
      .then(res => {
        console.log("exito");
    ...
    return (
      <div>
        <Card>
          <CardHeader>
            Lista de obras
            <button className="btn btn-outline-primary btn-sm float-right" onClick={this.modalNUsuario} >
              Nuevo Usuario
            </button>
          </CardHeader>
          <CardBody>
              ...
              <Table className="table table-bordered table-hover table-sm table-dark">
                <Thead>
                  <Tr>
                    ...
                    <Th className="text-center">Cpt</Th>
                    <Th className="text-center">Celular</Th>
                    <Th className="text-center">Último Usuario</Th>
                        ...
                        <Td>
                          <div className="d-flex">
                            <button
                              ...
                              id={`e${index}`}
                              onClick={e => this.IdUser(usuario.id_usuario)}
                            >
                              crear acceso
                            </button>
                            <button
                              ...
                              id={`e${index}`}
                              onClick={e =>
                                this.modalEditarUsuario(usuario.id_usuario)
                              }
                            >
                              Editar
                            </button>
                            ...
                            <button
                              ...
                              onClick={e =>
                                this.elminarUsuario(usuario.id_usuario)
                              }
                            >
                              Eliminar
                            </button>
        ...
        >
          <Form onSubmit={this.enviarDatosUsuarios}>
            <ModalBody>
              ...
              <FormGroup>
                ...
                <DebounceInput
                  ...
                  id="cpt"
                  placeholder="cpt"
                  onChange={e => this.setState({ cpt: e.target.value })}
                  debounceTimeout={300}
                  required
                />
              </FormGroup>
              ...
              <FormGroup>
                ...
                <th>
                  <input
                    type="file"
                    name="imagen1"
                    onChange={e => this.setState({ imagen: e.target.files[0] })}
                  />
                </th>
              </FormGroup>
            </ModalBody>
            ...
            <ModalFooter>
              ...
              <Button color="danger" onClick={this.modalNUsuario}>
                Cerrar{" "}
              </Button>
            </ModalFooter>
          </Form>
        ...
        <Modal
          ...
          fade={false}
          toggle={this.SwitchmodalEditarUsuario}
          className={this.props.className}
        >
            ...
            <ModalBody>
              <FormGroup>
                ...
                <input
                  className="form-control"
                  id="nombre"
                  defaultValue={nombre_editable}
                  onChange={e =>
                    this.setState({ nombre_editable: e.target.value })
                  }
                  required
                />
              </FormGroup>
              ...
              <FormGroup>
                ...
                <input
                  className="form-control"
                  id="apellido_Paterno"
                  defaultValue={apellido_paterno_editable}
                  onChange={e =>
                    this.setState({ apellido_paterno_editable: e.target.value })
                  }
                  required
                />
              </FormGroup>
              ...
              <FormGroup>
                ...
                <input
                  className="form-control"
                  id="apellido_Materno"
                  defaultValue={apellido_materno_editable}
                  onChange={e =>
                    this.setState({ apellido_materno_editable: e.target.value })
                  }
                  required
                />
              </FormGroup>
              ...
              <FormGroup>
                ...
                <input
                  ...
                  type="number"
                  id="dni"
                  defaultValue={dni_editable}
                  onChange={e =>
                    this.setState({ dni_editable: e.target.value })
                  }
                  required
                />
              </FormGroup>
              ...
              <FormGroup>
                ...
                <input
                  className="form-control"
                  id="direccion"
                  defaultValue={direccion_editable}
                  onChange={e =>
                    this.setState({ direccion_editable: e.target.value })
                  }
                  required
                />
              </FormGroup>
              ...
              <FormGroup>
                ...
                <input
                  className="form-control"
                  id="email"
                  defaultValue={email_editable}
                  onChange={e =>
                    this.setState({ email_editable: e.target.value })
                  }
                  required
                />
              </FormGroup>
              ...
              <FormGroup>
                ...
                <input
                  ...
                  className="form-control"
                  id="celular"
                  defaultValue={celular_editable}
                  onChange={e =>
                    this.setState({ celular_editable: e.target.value })
                  }
                  required
                />
              </FormGroup>
              ...
              <FormGroup>
                ...
                <input
                  className="form-control"
                  id="cpt"
                  defaultValue={cpt_editable}
                  onChange={e =>
                    this.setState({ cpt_editable: e.target.value })
                  }
                  required
                />
              </FormGroup>
