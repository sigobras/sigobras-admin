...
import { Modal, ModalHeader, ModalBody, ModalFooter, Row, Col, FormGroup, Label, Input, Button, FormFeedback } from 'reactstrap';
export default () => {
	useEffect(() => {
		fetchUsuarios()
		fetchObras()
	...
	//asignar obra
	async function asignarObra(id_acceso, id_ficha) {
		try {
									...
									[
										<tr
											...
											onDrop={(e) => {
												...
												asignarObra(item.id_acceso, id_ficha)
											}}
										...
										>
											<td
												onClick={() => onChangeUsuarioSeleccionado(item.id_acceso)}
											>
												{
													item.id_acceso
												}
						...
						<Col md={6}>
							<FormGroup>
								...
								<Input
									...
									onChange={e => onChangeInputFormulario("usuario", e.target.value)}
									className="form-control"
						...
						<Col md={6}>
							<FormGroup>
								...
								<Input
									...
									onChange={e => onChangeInputFormulario("password", e.target.value)}
									className="form-control"
								// invalid={Verificador && !DataFormulario.apellido_paterno}
								/>
							</FormGroup>
